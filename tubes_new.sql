...
/* Created on:     31/12/2021 08:10:46                          */
/*==============================================================*/
...
alter table PAYMENTS
   drop constraint FK_PAYMENTS_PAY_PACKAGES;

alter table SUBTITLES
   drop constraint FK_SUBTITLE_USE_MOVIES;

alter table WATCH
   drop constraint FK_WATCH_WATCH_MEMBERS;

alter table WATCH
   drop constraint FK_WATCH_WATCH2_MOVIES;
...
/* Index: PAY_FK                                                */
/*==============================================================*/
create index PAY_FK on PAYMENTS (
   ID_PACKAGE ASC
);
...
/* Index: WATCH_FK                                              */
/*==============================================================*/
create index WATCH_FK on WATCH (
   ID_MEMBER ASC
);
...
/* Index: WATCH2_FK                                             */
/*==============================================================*/
create index WATCH2_FK on WATCH (
   ID_MOVIE ASC
);
...
alter table PAYMENTS
   add constraint FK_PAYMENTS_PAY_PACKAGES foreign key (ID_PACKAGE)
      references PACKAGES (ID_PACKAGE);
...
alter table WATCH
   add constraint FK_WATCH_WATCH_MEMBERS foreign key (ID_MEMBER)
      references MEMBERS (ID_MEMBER);

alter table WATCH
   add constraint FK_WATCH_WATCH2_MOVIES foreign key (ID_MOVIE)
      references MOVIES (ID_MOVIE);
